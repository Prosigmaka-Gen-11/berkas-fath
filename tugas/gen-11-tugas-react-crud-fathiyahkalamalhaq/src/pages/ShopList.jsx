...
export default function ShopList(){
    ...
    return <>
        <h1 className="text-cyan-700 text-3xl font-bold font-sans text-center p-5">List Pemesanan Product</h1>
        <div className="overflow-x-auto relative">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                <thead className="text-xs text-gray-700 uppercase bg-sky-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                ...
                <tbody>
                    ...
                    key={i.id}>
                        ...
                        <td className="py-4 px-6 flex justify-between">
                            ...
                            <Link to={'/shop/form/'+i.id}>
                                <button onClick={() => prepareEdit(i)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
